...
const content = [
    ...
    "其昆.事.非.奇.。.白.兎.声.「.啊.、.啊.、.可.成.緩.！.」.、.経.竹六.耳.之.而.等.不.魂.為.大.怪.。.在.先時.竹六.思.之.去.為.怪.、.回.在.其.時.魂.為.真.遍.事.。.回.白.兎.出.時斉.元.衣囊.在.外衣.、.而.目:2.其.而.開.回.走.経.竹六.浮知.、.不.有.目:2.有.衣囊.在.外衣.然.兎.、.来.出.時斉.元.衣.然.兎.、.故.立跳.。.竹六.知拘.内.其.、.故.従.於.白.兎.而.越.原田.、.経.成.豊時.在.現.目:2.白.兎.跳入.行.大.洞.在.刈壁.然.下.処.。",
    "消天透.、.追.竹六.従.於.其.而.等.跳入.行.其.。.去.糸虚.思.出.以.何法.元.其.処.。",
    "在.一序.処.兎.大.洞.為.縦行.道.態.掘道.、.経.跳暗.成.大.傾.追.代.行.下.態.落立.。.道.溢.跳暗.歪.故.竹六.思.止.体.然.時.虚.、.在.媛.目:2.然.時.、.竹六.現.落.行.下.内.大.深.汲洞.。",
    "汲洞.概.為.大.深.、.岐.竹六.概.大.緩.落.。.故.並.落.内.汲洞.、.目:2.周.処.、.追.思.何.事.開.在.先時.然.時.多.居.。.在一.媛.目:2.下.而.且.解明.先.到.何.処.、.回.其.為.溢.暗.故.不.能.目:2.唯一.物.。.経.媛.目:2.横.壁.在.汲洞.、.追.解明.餐具.函机.来.帳函.据.在.悉.壁.、.追.領紙.来.画.居居.垂.以.紙釘.。.媛.取.一.貝.瓶.元.函机.並.通越.、.在.名記.書.〈.柑.果汁.〉.。.回.其.為.虚湛.故.成.大.枯魂.。.媛.恐.狩.或人.在.下.処.而.不.且.落.虚湛.瓶.、.故.並.落.隣.外.函机.、.百弓千思.而.据.其.在.其.函机.。",
