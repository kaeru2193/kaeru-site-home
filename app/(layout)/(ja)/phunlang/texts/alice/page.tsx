...
const content = [
    "竹六.座.隣.姉.在.川累.、.唯一.做.事.虚.故.開.大.遊思.。.媛.一.二.追.間目.姉.記.然.帳.、.回.其.不.有.画.来.衆談.。.竹六.魂.、.「.不.有.画.来.衆談.然.帳.、.向.何.能.使.之昆.帳.如.？.」",
    ...
    "汲洞.概.為.大.深.、.岐.竹六.概.大.緩.落.。.故.並.落.内.汲洞.、.目.周.処.、.追.思.何.事.開.在.先時.然.時.多.居.。.在一.媛.目.下.而.且.解明.先.到.何.処.、.回.其.為.溢.暗.故.不.能.目.唯一.物.。.経.媛.目.横.壁.在.汲洞.、.追.解明.餐具.函机.来.帳函.据.在.悉.壁.、.追.領紙.来.画.居居.垂.以.紙釘.。.媛.取.一.貝.瓶.元.函机.並.通越.、.在.名記.書.〈.柑.果汁.〉.。.回.其.為.虚湛.故.成.大.枯魂.。.媛.恐.狩.或人.在.下.処.而.不.且.落.虚湛.瓶.、.故.並.落.隣.外.函机.、.百弓千思.而.据.其.在.其函机.。",
    "竹六.思.、.「.我.有.之昆.落.、.故.在.先時.我.衝落.在.踏踏.而.先.不.魂.唯一.事.！.悉.庵昆.万定.思.我.有.大.魂勇.在.庵.！.唔.、.我.落.元.庵.然.頂.処.、.模真.糸虚.言.向.其.！.」.其.概.真事.。.落.元.庵.然.頂.処.模.媛.不.能.言.唯一.事.！",
